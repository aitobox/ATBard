...
from .views import health_view, recite_view, history_view, index_view, settings_view, export_history_zip_view
...
urlpatterns = [
    ...
    path('api/history/export', export_history_zip_view, name='export_history_zip'),
